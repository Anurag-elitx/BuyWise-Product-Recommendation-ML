                ...
                <div className="col-xl-2 d-none d-lg-block">
                  <div className="logo">
                    <Link to="/">
                      ...
                      <h2 className="logo-text ml-3 mb-0" style={{ fontFamily: 'var(--font-heading)', color: 'var(--primary)', fontWeight: 700, fontSize: '2rem' }}>BuyWise</h2>
                      {/* Logo Replaced */}
                    </Link>
                  </div>
                </div>
                    ...
                    <nav className="menu-nav">
                      ...
                      <div className="header-category d-none d-lg-block">
                        ...
                        <ul className="category-menu">
                          ...
                          <li>
                            <Link to="/dairy">
                              <i className="fas fa-cheese"></i> Dairy Products
                            </Link>
                          </li>
                        </ul>
                      </div>
