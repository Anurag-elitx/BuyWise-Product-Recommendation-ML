                ...
                <div className="footer-wrap">
                    <div className="container first_class">
                        <div className="row" id="footer-row">
                            <div className="col-md-4 col-sm-6">
                                ...
                                <p>Get all the latest information on BuyWise Services, Events, Receipes and Discounts. Sign up for our newsletter today.</p>
                            </div>
                            <div className="col-md-4 col-sm-6">
                        ...
                        <div className="container second_class_bdr">
                            <div className="row">
                                <div className="col-md-4 col-sm-6">
                                    ...
                                    <div className="footer-logo"><h2 style={{ color: 'white', fontFamily: 'var(--font-heading)' }}>BuyWise</h2>
                                    </div>
                                </div>
                                ...
                                <div className="col-md-3 col-sm-6">
                                    ...
                                    <ul className="footer-category">
                                        <li><Link to="/">BuyWise - Ambassadors</Link>
                                        </li>
                                    </ul>
                                    <div className="clearfix"></div>
                                </div>
                                <div className="col-md-3 col-sm-6">
                                    ...
                                    <ul className="footer-links">
                                        <li><Link to="/">BuyWise Events</Link>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div className="row">
                        ...
                        <div className="container-fluid">
                            <div className="copyright"> Copyright 2026 | All Rights Reserved by BuyWise</div>
                        </div>
